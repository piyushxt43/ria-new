    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-12 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <h2 className="text-3xl font-bold mb-8 text-gray-800">Getting Started</h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-gray-800">Using Posture Check</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-gray-800">Using Mood Detector</h3>
                        <ol className="space-y-3 text-gray-700">
                            <li className="flex items-start gap-2">
                ...
                <motion.div
                    ...
                    className="mt-12 text-center bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-12 text-white"
                >
